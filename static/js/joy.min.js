...
// Obtener todos los botones de flecha
const arrowButtons = document.querySelectorAll('.arrow');
const keyStatus = document.getElementById('key-status');

// Función para activar un botón de flecha
...
// Función para desactivar un botón de flecha
...
// Función para desactivar todos los botones de flecha
...
document.addEventListener('keydown', function(event) {
    ...
    if (['w', 'a', 's', 'd', 'l', 'k'].includes(key)) {
        // Desactivar todos los botones antes de activar uno
        deactivateAllButtons();
        // Activar el botón correspondiente a la tecla presionada
        activateButton(key);
        // Enviar tecla al servidor o realizar la acción necesaria
        // Aquí puedes agregar el código necesario para enviar la tecla al servidor
    }
});

// Escuchar eventos de teclado al soltar la tecla
document.addEventListener('keyup', function(event) {
    const key = event.key.toLowerCase();
    if (['w', 'a', 's', 'd', 'l', 'k'].includes(key)) {
        // Desactivar el botón correspondiente a la tecla soltada
...
// Llamar a AddData cada 10 milisegundos
